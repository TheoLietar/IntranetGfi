...
<script type="text/javascript">
    function render(link) {
        ...
        document.querySelector("#ifram").innerHTML = `<iframe scrolling="no" frameborder="0" style="border: 1px solid #ccc;border-radius: 5px;overflow: hidden;width: 975px;height: 600px;" allowtransparency="true" target="new" src=https://` + tmp + `></iframe>`
    }
